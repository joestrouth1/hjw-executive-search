<template>
  <div class="container mx-auto">
    ...
    <main id="content">
      ...
      <nuxt-link :to="{ name: 'contact', query: { job: job.title } }" class="block md:inline-block text-blue-darkest bg-blue-lighter leading-none mx-6 my-4 py-2 px-4 text-center no-underline rounded shadow">
        Contact us
      </nuxt-link>
    </main>
  </div>
